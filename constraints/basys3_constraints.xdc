...
##VGA Connector
set_property PACKAGE_PIN G19 [get_ports {o_wb_reg_w_data[23]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {o_wb_reg_w_data[23]}]
set_property PACKAGE_PIN H19 [get_ports {o_wb_reg_w_data[24]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {o_wb_reg_w_data[24]}]
set_property PACKAGE_PIN J19 [get_ports {o_wb_reg_w_data[25]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {o_wb_reg_w_data[25]}]
set_property PACKAGE_PIN N19 [get_ports {o_wb_reg_w_data[26]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {o_wb_reg_w_data[26]}]
set_property PACKAGE_PIN N18 [get_ports {o_wb_reg_w_data[27]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {o_wb_reg_w_data[27]}]
set_property PACKAGE_PIN L18 [get_ports {o_wb_reg_w_data[28]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {o_wb_reg_w_data[28]}]
set_property PACKAGE_PIN K18 [get_ports {o_wb_reg_w_data[29]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {o_wb_reg_w_data[29]}]
set_property PACKAGE_PIN J18 [get_ports {o_wb_reg_w_data[30]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {o_wb_reg_w_data[30]}]
set_property PACKAGE_PIN J17 [get_ports {o_wb_reg_w_data[31]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {o_wb_reg_w_data[31]}]
set_property PACKAGE_PIN H17 [get_ports o_clk]				
	set_property IOSTANDARD LVCMOS33 [get_ports o_clk]
set_property PACKAGE_PIN G17 [get_ports o_locked]				
